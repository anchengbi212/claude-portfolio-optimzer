...
class PortfolioOptimizer:
    def __init__(self, tickers, start_date=None, end_date=None, custom_dates=None):
        """
        ...
        custom_dates (dict): Optional dict with ticker-specific dates
                            Format: {'AAPL': ('2020-01-01', '2024-01-01'), ...}
        """
...
def main_menu():
    ...
    while True:
        ...
        print("MAIN MENU")
        print("="*60)
        print("1. Enter/Change Portfolio")
        print("2. Show Optimal Portfolios")
        print("3. Plot Efficient Frontier")
        ...
        if choice == '1':
            ...
            try:
                if custom_dates:
                    optimizer = PortfolioOptimizer(tickers, custom_dates=custom_dates)
